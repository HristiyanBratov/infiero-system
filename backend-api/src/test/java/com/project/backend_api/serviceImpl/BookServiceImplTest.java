...
//        bookService = new BookServiceImpl(bookRepository, bookDTOMapper,  authorRepository,  genreRepository);
...
//     when(bookRepository.save(createBookRequest.)).thenReturn(createBookRequest);
//     assertThat(bookService.createBook(createBookRequest)).isEqualTo("Book created successfully.");
//    }
//
//    @Test
//    void testUpdateBook() {
